...
## 実行方法
### 環境
システムの開発および動作確認は，Python 3.6.8 を MacOC Catalina (10.15.5)において行いました．
...
```
都合上リポジトリ上に存在しないファイルがあるため，
実行に必要なファイルは，都合上リポジトリ上に存在しないファイルがあるため，[ここから]() ダウンロードしてください．
...
- /FashionRecommendation//utils/transforms.pyのGetFaceクラス
- /FashionRecommendation/utils/haarcascades
